...
public class Query {
    ...
    public static final String GET_LOCATION_TO_UPDATE = "from Location where id not in(1,27,38,39,40)"; // sensori non in teralab PA: 28-40-41-42
//public static final String GET_LOCATION_TO_UPDATE = "from Location where id = 1"; // sensori non in teralab PA: 28-40-41-42
